...
export class Quiz {
    ...
    private objJSONQuiz: JSON = null;
    private arrBonnesReponses: Array<string> = Array('', '2', '0', '0');
    ...
    private afficherQuestion = () => {
        const numero: string = 'Q' + this.questionActive;
    ...
    private cliquerBoutonValiderMonChoix = () => {
        ...
        let radios: [HTMLInputElement] = Array.apply(null, document.getElementsByName('Q' + this.questionActive));
    ...
    private cliquerBoutonProchaineQuestion = () => {
        // setTimeout(function () {
